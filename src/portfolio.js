...
const seo = {
  title: "Solahudeen Abdulrahmon | Software Engineer Portfolio",
  description:
    "A passionate Software Engineer with 4+ years of experience in Frontend and mobile development. Specializing in React, JavaScript, TypeScript, and modern web technologies. View my portfolio of projects and professional experience.",
  og: {
    title: "Solahudeen Abdulrahmon | Software Engineer Portfolio",
    type: "website",
    url: "https://github.com/salatech",
    image: "https://avatars.githubusercontent.com/u/69428338?v=4",
    site_name: "Solahudeen Abdulrahmon Portfolio"
  },
  twitter: {
    handle: "@salatech2",
    site: "@salatech2",
...
const greeting = {
  ...
  subTitle:
    "I am a Software engineer with 4+ years of experience. Proficient in Frontend and mobile development. Knowledgeable in modern software development best practices, tools, algorithms, and concepts. I enjoy building communities and sharing my knowledge. I never stop learning.",
  resumeLink:
    "https://www.canva.com/design/DAFbxSutuHU/4LXwyGigWvn2TzlchEk_FQ/edit?utm_content=DAFbxSutuHU&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton",
      ...
      skills: [
        {
          ...
          skill:
            "Html, css, JavaScript, TypeScript, Reactjs, Nextjs, React Native, Tailwind, Shadcn, Bootstrap, MUI",
        },
        {
        ...
        },
        {
          ...
          image:
            "https://res.cloudinary.com/dvd8hlffl/image/upload/v1704991334/code_wtnzgi.png",
          skill:
        ...
        },
        {
          title: "Others",
          skill:
            "Mathematics and Statistics, Machine Learning and Artificial Intelligence, Computer Engineering",
        },
      ],
    },
  ],
  ...
  degrees: [
    {
      ...
      description: [
        ...
        "Completed bachelor of technology with distinctions.",
      ],
    },
    {
      date: "2015-2018",
...
const certifications = {
  certifications: [
    ...
    },
    {
      ...
      logo_path:
        "https://www.simplilearn.com/ice9/team_images/author_simplilearn.jpg",
      certificate_link: "https://simpli-web.app.link/e/TrhZ5uOzQNb",
      alt_name: "Simplilearn",
      color_code: "#013856",
    },
    {
      ...
      experiences: [
        {
          ...
          company: "H30",
          company_url: "https://www.solahudeen.vercel.app/",
          logo_path:
            "https://res.cloudinary.com/dvd8hlffl/image/upload/v1744321127/my%20portfolio/v64nsqthphi8ennhkbi3.png",
          duration: "Nov 2024 - Present",
          location: "Remote",
          description:
            " I design and implement AI based healthcare copilot for physicians and healthcare professionals for the company, both web apps and mobile apps. Integrated powerful latest technologies to improve the system and make it more efficient.",
          color: "#004793",
        },
        {
